<template>
  <div
    ...
    tabindex="-1"
    role="dialog"
    aria-labelledby="add_bool_label"
    aria-hidden="true"
  >
              ...
              <div class="form-group col-md-2">
                <div class="form-check">
                  ...
                  <input
                    ...
                    type="checkbox"
                    id="gridCheck"
                    v-model="data.book_status"
                  >
                  <label
                    class="form-check-label"
                    for="gridCheck"
                  >{{data.book_status?"Disponible":"No Disponible"}}</label>
                </div>
              </div>
            </div>
